...
#This script reads through the SRA_numbers.txt file, which contains all of the SRA accession numbers required for the project, and then downloads them with prefetch
